class_name CropsCurcorComponent
extends Node
...
var corn_plant_scene = preload("res://scenes/objects/plant/corn.tscn")
var tomato_plant_scene = preload("res://scenes/objects/plant/tomato.tscn")
