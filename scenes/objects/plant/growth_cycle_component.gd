...
func growth_states(starting_day: int, current_day: int):
	...
	var growth_days_passsed = (current_day - starting_day) % num_states
	var state_index = growth_days_passsed % num_states + 1
...
func havest_state(starting_day: int, current_day: int):
